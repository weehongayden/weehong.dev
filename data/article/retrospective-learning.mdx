...
1. Write to-do list daily
   <br />5 ~ 10 items include work, study or life chores
2. Prepare a timer
   <br />
   Track your task with a timer to understand the time taken to complete a task.
   It helps to better gauge the number of tasks being completed in a day.
   <br />
