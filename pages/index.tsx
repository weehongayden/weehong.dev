...
const Home: NextPage = () => {
  return (
    <Layout>
      <Container classNames="grid gap-0 grid-cols-1 sm:gap-5 sm:grid-cols-3">
        <div className="flex flex-col order-2 col-span-2 sm:order-first">
          ...
          <h2 className="text-lg text-center my-1 sm:text-left">
          ...
          <div className="flex mt-5 justify-center sm:justify-start">
            <Link href="https://github.com/WeeHong/">
              <a
                className="text-blue-500 text-center dark:text-yellow-300 text-lg mr-5"
                target="_blank"
                rel="noreferrer"
              >
                GitHub
            ...
            <Link href="https://www.linkedin.com/in/weehongayden/">
              <a
                className="text-blue-500 text-center dark:text-yellow-300 text-lg mx-5"
                target="_blank"
                rel="noreferrer"
              >
                LinkedIn
            ...
            <Link href="https://medium.weehong.me/">
              <a
                className="text-blue-500 text-center dark:text-yellow-300 text-lg ml-5"
                target="_blank"
                rel="noreferrer"
              >
                Medium
